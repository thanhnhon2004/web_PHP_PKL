...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0"><i class="fas fa-edit me-2"></i>Chỉnh sửa Album</h4>
        ...
        <form action="{{ route('admin.albums.update', $album->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('photographer_name') is-invalid @enderror" 
                               id="photographer_name" name="photographer_name" 
                               value="{{ old('photographer_name', $album->photographer_name) }}">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <small class="text-muted">Để trống nếu không muốn thay đổi hình ảnh. Tối đa: 10MB</small>
                        @error('image')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div id="imagePreview" class="mt-3 text-center">
                        @if($album->image)
                        <img id="preview" src="{{ asset('img/albums/' . $album->image) }}" alt="{{ $album->title }}" 
            ...
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save me-2"></i>Cập nhật Album
                </button>
                <a href="{{ route('admin.albums.index') }}" class="btn btn-secondary">
