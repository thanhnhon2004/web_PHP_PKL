                ...
                <div
                    ...
                    <a href="index.html" class="navbar-brand">
                        <h1 class="m-0 text-uppercase text-white"><i
                                class="fa fa-camera fs-1 text-dark me-3"></i>cameramam</h1>
                    </a>
                    <p class="mt-3">Chúng tôi cung cấp dịch vụ chụp ảnh chuyên nghiệp, ghi lại những khoảnh khắc đẹp
                        và ý nghĩa của bạn.
                        Nhận chụp ảnh cá nhân, gia đình, sự kiện với phong cách đa dạng, chỉnh sửa ảnh chất lượng cao.
                        Đặt lịch chụp ảnh nhanh chóng, linh hoạt theo thời gian của bạn.</p>
                </div>
            </div>
                ...
                <div class="row gx-5">
                    ...
                    <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-secondary mb-2" href="#"><i
                                    class="bi bi-arrow-right text-primary me-2"></i>đặt lịch</a>
                            <a class="text-secondary mb-2" href="#"><i
                                    class="bi bi-arrow-right text-primary me-2"></i>ambum</a>
                            <a class="text-secondary mb-2" href="#"><i
                    ...
                    <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                        ...
                        <p>Liên hệ ngay để được tư vấn và đặt lịch chụp ảnh nhanh chóng.</p>
                        <form action="">
